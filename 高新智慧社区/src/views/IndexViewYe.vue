...
<div style="display: flex; margin: auto;width: 1150px;">
  <div class="card" style="float: left; width: 720px;height: 420px;">
    <div style="display: flex; margin-bottom: 20px;" >
      <img src="../assets/img/声音.png" style="width: 80px;height: 80px; " alt="">
      <div style="width:200px;font-size: 60px;line-height: 120px;margin-left: 30px;margin-top:-25px;margin-bottom: 30px ;color: #BA2D35;">通知</div>
    </div>
  ...
  <div class="card" style="float: left; width: 350px;height: 420px;margin-left: 25px;">
    <div style="float: left; width: 300px; height: 420px;margin-top: 0;" ref="pieChart"></div>
  </div>
</div>
